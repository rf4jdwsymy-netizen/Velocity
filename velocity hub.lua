...
function OrionLib:MakeWindow(WindowConfig)
	...
	local TitleIcon = SetProps(MakeElement("Image", "rbxassetid://83334192821646"), {
	...
	local MainWindow = SetChildren(SetProps(MakeElement("RoundImageFrame", Color3.fromRGB(255, 255, 255), 0, 10, "rbxassetid://108700588681395"), {
		Parent = Orion,
